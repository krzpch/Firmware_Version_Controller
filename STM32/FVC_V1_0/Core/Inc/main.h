...
#define PROC_BOOT0_GPIO_Port GPIOC
#define PROC_RESET_Pin GPIO_PIN_8
#define PROC_RESET_GPIO_Port GPIOC
#define RS485_SHDN_Pin GPIO_PIN_8
#define RS485_SHDN_GPIO_Port GPIOA
